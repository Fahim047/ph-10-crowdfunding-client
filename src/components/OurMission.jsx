				...
				<div className="grid md:grid-cols-2 gap-8 items-center">
					...
					<div className="space-y-6 md:space-y-8">
						...
						<p className="text-lg md:text-xl text-gray-600 leading-relaxed">
							...
							real difference. Whether it's personal issue, startup, supporting
							orphanages, charity or environmental campaign, we strive to
							inspire positive change through collective generosity.
						</p>
